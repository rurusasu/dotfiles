...
class HermesAgentHandler : SetupHandlerBase {
    ...
    hidden [string[]] GetArticleNewsSlackScriptLines() {
        return @(
            ...
            '      case "$key" in',
            '        SLACK_BOT_TOKEN) [ -z "${SLACK_BOT_TOKEN:-}" ] && export SLACK_BOT_TOKEN="$value" ;;',
            '        ARTICLE_NEWS_SLACK_CHANNEL) [ -z "${ARTICLE_NEWS_SLACK_CHANNEL:-}" ] && export ARTICLE_NEWS_SLACK_CHANNEL="$value" ;;',
            '        ARTICLE_NEWS_LIMIT) [ -z "${ARTICLE_NEWS_LIMIT:-}" ] && export ARTICLE_NEWS_LIMIT="$value" ;;',
            '        ARTICLE_NEWS_LIFELOG_INBOX_DIR) [ -z "${ARTICLE_NEWS_LIFELOG_INBOX_DIR:-}" ] && export ARTICLE_NEWS_LIFELOG_INBOX_DIR="$value" ;;',
            '        ARTICLE_NEWS_ACP_AGENT) [ -z "${ARTICLE_NEWS_ACP_AGENT:-}" ] && export ARTICLE_NEWS_ACP_AGENT="$value" ;;',
            '        ARTICLE_NEWS_TRANSLATE_LANG) [ -z "${ARTICLE_NEWS_TRANSLATE_LANG:-}" ] && export ARTICLE_NEWS_TRANSLATE_LANG="$value" ;;',
            '      esac',
