...
Describe 'CI workflow configuration' {
    ...
    It 'should run install.cmd in CI with timeout and completion marker checks' {
        ...
        $installerScript | Should -Match 'oversizedUserPathEntries = 1\.\.500'
        ...
        $installerScript | Should -Match 'SetEnvironmentVariable\(''PATH'', \$seededUserPath, ''User''\)'
        $installerScript | Should -Match 'User PATH repaired: removed'
        $installerScript | Should -Match 'remainingStaleUserPathEntries'
        $installerScript | Should -Match 'SetEnvironmentVariable\(''PATH'', \$originalUserPath, ''User''\)'
