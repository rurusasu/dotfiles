...
```bash
git -C ../hermes-home-distribution add root-distribution.yaml cron/jobs.json SOUL.md scripts/hermes_home_sync.sh scripts/lifelog_sync.sh scripts/article_news_slack.sh scripts/validate_distribution.py tests/test_validate_distribution.py
